...
Echo_Warn()
{
	echo $(Color_Text "WARNING: ************************************************************" "34")
    echo $(Color_Text "WARNING: $1" "33")
    echo $(Color_Text "WARNING: ************************************************************" "34")
}

Echo_Success()
{
	echo $(Color_Text "SUCCESS: ************************************************************" "34")
    echo $(Color_Text "SUCCESS: $1" "32")
    echo $(Color_Text "SUCCESS: ************************************************************" "34")
}

Echo_Error()
{
	echo $(Color_Text "ERROR: ************************************************************" "34")
    echo $(Color_Text "ERROR: $1" "31")
    echo $(Color_Text "ERROR: ************************************************************" "34")
}
